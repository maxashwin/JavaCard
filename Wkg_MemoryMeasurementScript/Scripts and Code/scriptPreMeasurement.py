...
os.rename(originalFileName,originalFileName+"txt")
...
appletNameLineNumber = findClassName(originalFileName)
...
processMethodStart, processMethodEnd = findStartEndMethod(originalFileName, "public void process(")
...
with open(modifiedFileName, 'w') as inputFile:
	...
	insertClassVariableDeclarations(str(constructorLineMax))
	...
	for i in range(constructorStartLine, (processMethodStart-1)):
		inputFile.write(appletLineArray[i])
