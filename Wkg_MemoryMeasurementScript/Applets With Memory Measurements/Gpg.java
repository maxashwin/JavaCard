...
public final class Gpg extends Applet {
 ...
 /* Persistent : 72 bytes,  Transient(Deselect) : 1 bytes,  Transient(Reset) : 1 bytes */
 ...
 /* Persistent : 8 bytes,  Transient(Deselect) : 263 bytes,  Transient(Reset) : 263 bytes */
    commandChainingBuffer = JCSystem.makeTransientByteArray((short) (TEMP_PUT_KEY_ACCUMULATOR + RSA_KEY_LENGTH_BYTES),         JCSystem.CLEAR_ON_DESELECT);
 ...
 /* Persistent : 64 bytes,  Transient(Deselect) : 0 bytes,  Transient(Reset) : 0 bytes */
 ...
 /* Persistent : 1256 bytes,  Transient(Deselect) : 0 bytes,  Transient(Reset) : 0 bytes */
