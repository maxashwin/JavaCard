...
public class PKIApplet extends Applet implements ISO7816 {
 ...
 /* Persistent : 60 bytes,  Transient(Deselect) : 1 bytes,  Transient(Reset) : 1 bytes */
        pin = new OwnerPIN(PIN_TRIES, MAX_PIN_SIZE);

 /* Persistent : 56 bytes,  Transient(Deselect) : 1 bytes,  Transient(Reset) : 1 bytes */
 ...
 /* Persistent : 8 bytes,  Transient(Deselect) : 282 bytes,  Transient(Reset) : 282 bytes */
        tmp = JCSystem.makeTransientByteArray(TMP_SIZE,  JCSystem.CLEAR_ON_DESELECT);
        state = STATE_INITIAL;

 /* Persistent : 24 bytes,  Transient(Deselect) : 0 bytes,  Transient(Reset) : 0 bytes */
 ...
 /* Persistent : 500 bytes,  Transient(Deselect) : 0 bytes,  Transient(Reset) : 0 bytes */
 ...
 /* Persistent : 160 bytes,  Transient(Deselect) : 0 bytes,  Transient(Reset) : 0 bytes */
        tempKeyPublic = (RSAPublicKey)KeyBuilder.buildKey(KeyBuilder.TYPE_RSA_PUBLIC, KeyBuilder.LENGTH_RSA_1024, false);

 /* Persistent : 8 bytes,  Transient(Deselect) : 2 bytes,  Transient(Reset) : 2 bytes */
 ...
 /* Persistent : 96 bytes,  Transient(Deselect) : 2 bytes,  Transient(Reset) : 2 bytes */
